...
class FragmentVehicleListStatus : Fragment() {

    private lateinit var allListAdapter: GenericAdapter<Any>
    private val TAG = FragmentVehicleListStatus::class.java.simpleName
    private var mDataList = ArrayList<FranchiseLogisticsRecordX> ()
   companion object {
       val ARG_LIST = "list"
        fun newInstance(myList : ArrayList<FranchiseLogisticsRecordX>): FragmentVehicleListStatus {
            val args = Bundle()
            args.putParcelableArrayList(ARG_LIST,myList)
            val fragment =
                FragmentVehicleListStatus()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mDataList = arguments!!.getParcelableArrayList(ARG_LIST)!!
